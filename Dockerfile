...
RUN /opt/python/cp27-cp27m/bin/pip2.7 install -r requirements_test.txt
...
RUN /opt/python/cp35-cp35m/bin/pip3.5 install -r requirements_test.txt
...
RUN /opt/python/cp36-cp36m/bin/pip3.6 install -r requirements_test.txt
...
RUN /opt/python/cp37-cp37m/bin/pip3.7 install -r requirements_test.txt
...
RUN /opt/python/cp38-cp38/bin/pip3.8 install -r requirements_test.txt # no binaries for scipy
